//! This file contains examples from the Bevy engine on how to show a "neon" style light.
//! https://bevy.org/examples/2d-rendering/bloom-2d/
//!
//! This is being kept for now as a reference.
